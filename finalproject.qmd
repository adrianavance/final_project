...
chr_small <- 
  ...
  select(state_fips = 'State FIPS Code',
         ...
         child_poverty = 'Children in Poverty raw value',
         income_inequality = 'Income Inequality raw value',
         air_pollution = 'Air Pollution - Particulate Matter raw value',
         limited_healthy_food = 'Limited Access to Healthy Foods raw value',
         uninsured_adults = 'Uninsured Adults raw value',
         uninsured_children = 'Uninsured Children raw value',
         childcare_cost_burden = 'Child Care Cost Burden raw value',
         traffic_volume = 'Traffic Volume raw value',
         rural = '% Rural raw value', 
         hs_grad_rate = 'High School Graduation raw value',
