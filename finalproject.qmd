...
The following function models a change in women participating in the WIC program, which is a food assistance program targeted to new mothers and infants in need of supplemental nutrition assistance. The program provides staple foods to mothers and children who meet nutritional risk criteria. We targeted the simulation to change participation in WIC for counties with persistent childhood poverty, which is another important predictor identified by our random forest model.  
```{r}
...
While the change is incremental, it is clear that WIC participation is a strong predictor of food insecurity levels, and the strength of this relationship varies across population levels of counties. 
...
A simulation like this is useful for understanding the relationship between population, WIC participation, and food insecurity levels. Understanding this can lead to policy change like an expansion of the WIC program, which may help to decrease food insecurity overtime. 
```{r}
