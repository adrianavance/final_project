...
The anti joins above show the counties in the food atlas dataset that are not represented in the CHR dataset, and vice versa. All of these counties were either changed or deleted in the time that these data were collected. In order to be able to merge our datasets, we will remove these counties from the data.
